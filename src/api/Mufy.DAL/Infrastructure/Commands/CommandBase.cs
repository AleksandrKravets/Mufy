...
namespace Mufy.DAL.Infrastructure.Commands
{
    internal abstract class CommandBase<TResult>
    {
        ...
        protected abstract Task<TResult> ExecuteAsync(DbCommand command);

        public async Task<TResult> ExecuteAsync(StoredProcedure storedProcedure)
        {
            TResult result;
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                result = await ExecuteAsync(_command);
